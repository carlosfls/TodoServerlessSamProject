...
import org.carlosacademic.dtos.*;
import org.carlosacademic.exeptions.ApiException;
import org.carlosacademic.proxy.TodoProxy;
import org.carlosacademic.services.TodoSqsProcessor;
...
public class TodoLambdaGetter implements RequestHandler<CreateTodo, ApiResponseDto> {
    ...
    private final TodoSqsProcessor processor;
    private final ObjectMapper mapper = new ObjectMapper();

    public TodoLambdaGetter() {
        this.proxy = new TodoProxy(API_URL, client);
        this.processor = new TodoSqsProcessor(QUEUE_URL, sqsClient);
    }
